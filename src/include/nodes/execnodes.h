...
typedef struct RNNJoinState
{
	...
	TupleTableSlot *mj_OuterTempTupleSlot;
	TupleTableSlot *mj_PrevInnerTupleSlot;
	TupleTableSlot *mj_InnerTupleSlot;
	TupleTableSlot *mj_InnerTempTupleSlot;
	TupleTableSlot *mj_CurrInnerTupleSlot;
	TupleTableSlot *mj_MarkedTupleSlot;
	TupleTableSlot *mj_NullOuterTupleSlot;
	TupleTableSlot *mj_NullInnerTupleSlot;
	TupleTableSlot *mj_MarkedTempTupleSlot;
	 ...
	 *
	 */
	List *outernnBuffer; /* buffer of outer tuples */
	ListCell *cont; /* pointer to the cont-th element in buffer */
	ListCell *prev_cont;

	size_t agg_count;
	float8 agg_sum;
	size_t agg_local_count;
	float8 agg_local_sum;
	List *group_pos_inner;
	List *group_pos_outer;

	List *aggSamples;
	List *localAggSamples;
	ListCell *aggCont;
	ListCell *localCont;
	ListCell *prev_aggCont;
	ListCell *prev_localCont;
	ListCell *equiCont;
	...
	float8 agg_min;
	float8 agg_max;
	float8 agg_local_min;
	float8 agg_local_max;



  List *sample_pos_inner; /*positions of attribute sample in the outer relation*/
  List *sample_pos_outer; /*positions of attribute sample in the inner relation */

  int time_pos_inner;
  int time_pos_outer;

  List *aggFuncs;
	int pos_M; /* position of attribute M in inner relation */
	bool aggCheck;
	List *positions;
	bool buffCheck;

	bool isRestored;
	List *outerequiBuffer;
