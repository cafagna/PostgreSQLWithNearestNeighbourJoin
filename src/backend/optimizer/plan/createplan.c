					  ...
					  Plan *inner_plan)
{
	...
	join_plan->group_pos_inner=(List*)copyObject(best_path->group_pos_inner);
	join_plan->sample_pos_inner=(List*)copyObject(best_path->sample_pos_inner);
	join_plan->group_pos_outer=(List*)copyObject(best_path->group_pos_outer);
	join_plan->sample_pos_outer=(List*)copyObject(best_path->sample_pos_outer);
	join_plan->time_pos_outer=(best_path->time_pos_outer);
	join_plan->time_pos_inner=(best_path->time_pos_inner);
	join_plan->aggFuncs=(List*)copyObject(best_path->aggFuncs);
	join_plan->pos_M=(best_path->pos_M);
	join_plan->aggCheck=(best_path->aggCheck);
	join_plan->positions=(List*)copyObject(best_path->positions);
	join_plan->buffCheck=(best_path->buffCheck);
