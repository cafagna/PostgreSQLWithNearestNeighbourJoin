					 ...
					 List *restrictlist)
{
	 ...
	 * it's a full join.
	 */
	if (enable_mergejoin || jointype == JOIN_RNNJ || jointype == JOIN_FULL)
	 ...
	 */
	if (mergejoin_allowed && jointype!= JOIN_RNNJ)
	 ...
	 */
	if ((enable_hashjoin || jointype == JOIN_FULL) && jointype != JOIN_RNNJ)
					 ...
					 Relids extra_lateral_rels)
{
	...
	foreach(l, all_pathkeys)
	{
		...
		if(jointype==JOIN_RNNJ) // If RNNJ USE ONLY MERGE CLAUSE ORDER
			break;
	}
}
