...
_equalJoinExpr(const JoinExpr *a, const JoinExpr *b)
{
	...
	COMPARE_NODE_FIELD(alias);
	COMPARE_SCALAR_FIELD(rtindex);
	COMPARE_NODE_FIELD(equalOnClause);
	COMPARE_NODE_FIELD(nnByClause);
	COMPARE_NODE_FIELD(aggClause);
	COMPARE_NODE_FIELD(group_pos_inner);
	COMPARE_NODE_FIELD(group_pos_outer);
	COMPARE_NODE_FIELD(sample_pos_inner);
	COMPARE_NODE_FIELD(sample_pos_outer);
	COMPARE_SCALAR_FIELD(time_pos_inner);
	COMPARE_SCALAR_FIELD(time_pos_outer);
	COMPARE_NODE_FIELD(aggFuncs);
	COMPARE_SCALAR_FIELD(pos_M);
	COMPARE_SCALAR_FIELD(aggCheck);
    COMPARE_NODE_FIELD(positions);
    COMPARE_SCALAR_FIELD(buffCheck);
