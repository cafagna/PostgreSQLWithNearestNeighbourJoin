...
_copyMergeJoin(const MergeJoin *from)
{
	...
	COPY_NODE_FIELD(group_pos_inner);
	COPY_NODE_FIELD(group_pos_outer);
	COPY_NODE_FIELD(sample_pos_inner); /*positions of attribute sample in the outer relation*/
	COPY_NODE_FIELD(sample_pos_outer); /*positions of attribute sample in the inner relation */
	COPY_SCALAR_FIELD(time_pos_inner);
	COPY_SCALAR_FIELD(time_pos_outer);
	COPY_NODE_FIELD(aggFuncs);
	COPY_SCALAR_FIELD(pos_M); /* position of attribute M in inner relation */
	COPY_SCALAR_FIELD(aggCheck);
	COPY_NODE_FIELD(positions);
	COPY_SCALAR_FIELD(buffCheck);
...
_copyJoinExpr(const JoinExpr *from)
{
	...
	COPY_NODE_FIELD(alias);
	COPY_SCALAR_FIELD(rtindex);
	COPY_NODE_FIELD(equalOnClause);
	COPY_NODE_FIELD(nnByClause);
	COPY_NODE_FIELD(aggClause);
	COPY_NODE_FIELD(group_pos_inner);
	COPY_NODE_FIELD(group_pos_outer);
	COPY_NODE_FIELD(sample_pos_inner);
	COPY_NODE_FIELD(sample_pos_outer);
	COPY_SCALAR_FIELD(time_pos_inner);
	COPY_SCALAR_FIELD(time_pos_outer);
	COPY_NODE_FIELD(aggFuncs);
	COPY_SCALAR_FIELD(pos_M);
    COPY_SCALAR_FIELD(aggCheck);
    COPY_NODE_FIELD(positions);
    COPY_SCALAR_FIELD(buffCheck);
