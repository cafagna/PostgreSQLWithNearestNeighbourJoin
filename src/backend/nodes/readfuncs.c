...
_readJoinExpr(void)
{
	...
	READ_NODE_FIELD(equalOnClause);
	READ_NODE_FIELD(nnByClause);
	READ_NODE_FIELD(aggClause);
	READ_NODE_FIELD(group_pos_inner);
	READ_NODE_FIELD(group_pos_outer);
	READ_INT_FIELD(time_pos_inner);
	READ_INT_FIELD(time_pos_outer);
	READ_NODE_FIELD(sample_pos_inner);
	READ_NODE_FIELD(sample_pos_outer);
	READ_NODE_FIELD(aggFuncs);
	READ_INT_FIELD(pos_M);
	READ_BOOL_FIELD(aggCheck);
	READ_NODE_FIELD(positions);
	READ_BOOL_FIELD(buffCheck);
	READ_DONE();
}
