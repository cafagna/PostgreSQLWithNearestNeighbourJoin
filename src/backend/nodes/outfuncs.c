...
_outMergeJoin(StringInfo str, const MergeJoin *node)
{
	...
	WRITE_NODE_FIELD(group_pos_inner);
	WRITE_NODE_FIELD(group_pos_outer);
	WRITE_NODE_FIELD(sample_pos_inner); /*positions of attribute sample in the outer relation*/
	WRITE_NODE_FIELD(sample_pos_outer); /*positions of attribute sample in the inner relation */
	WRITE_INT_FIELD(time_pos_inner);
	WRITE_INT_FIELD(time_pos_outer);
	WRITE_NODE_FIELD(aggFuncs);
	WRITE_INT_FIELD(pos_M); /* position of attribute M in inner relation */
	WRITE_BOOL_FIELD(aggCheck);
	WRITE_NODE_FIELD(positions);
	WRITE_BOOL_FIELD(buffCheck);
}
...
_outJoinExpr(StringInfo str, const JoinExpr *node)
{
	...
	WRITE_NODE_FIELD(equalOnClause);
	WRITE_NODE_FIELD(nnByClause);
	WRITE_NODE_FIELD(aggClause);
	WRITE_NODE_FIELD(group_pos_inner);
	WRITE_NODE_FIELD(group_pos_outer);
	WRITE_NODE_FIELD(sample_pos_inner);
	WRITE_NODE_FIELD(sample_pos_outer);
	WRITE_INT_FIELD(time_pos_inner);
	WRITE_INT_FIELD(time_pos_outer);
	WRITE_NODE_FIELD(aggFuncs);
	WRITE_INT_FIELD(pos_M);
    WRITE_BOOL_FIELD(aggCheck);
    WRITE_NODE_FIELD(positions);
    WRITE_BOOL_FIELD(buffCheck);
