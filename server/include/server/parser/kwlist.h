...
PG_KEYWORD("aggr", AGGR, RESERVED_KEYWORD)
...
PG_KEYWORD("backtrack", BACKTRACK, RESERVED_KEYWORD)
...
PG_KEYWORD("equal", EQUAL, RESERVED_KEYWORD)
...
PG_KEYWORD("nn", NN, RESERVED_KEYWORD)
...
PG_KEYWORD("rnnj", RNNJ, RESERVED_KEYWORD)
